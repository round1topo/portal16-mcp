namespace TiaMcpServer
{
    public class CliOptions
    {
        ...
        public int? TiaPortalProcessId { get; set; } // optional running Portal process PID
        ...
        public bool ListPortalProcessIds { get; set; }
        ...
        public static CliOptions ParseArgs(string[] args)
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
                switch (args[i].ToLowerInvariant())
                {
                    ...
                    case "-tia-portal-process-id":
                    case "--tia-portal-process-id":
                        if (i + 1 < args.Length && int.TryParse(args[i + 1], out int portalProcessId))
                        {
                            options.TiaPortalProcessId = portalProcessId;
                            i++;
                        }
                        break;
                    ...
                    case "--list-portal-process-ids":
                        options.ListPortalProcessIds = true;
                        break;
